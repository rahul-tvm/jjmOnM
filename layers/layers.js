...
var format_clip_KWA_RESERVOIR_4 = new ol.format.GeoJSON();
var features_clip_KWA_RESERVOIR_4 = format_clip_KWA_RESERVOIR_4.readFeatures(json_clip_KWA_RESERVOIR_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_clip_KWA_RESERVOIR_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_clip_KWA_RESERVOIR_4.addFeatures(features_clip_KWA_RESERVOIR_4);
var lyr_clip_KWA_RESERVOIR_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_clip_KWA_RESERVOIR_4, 
                style: style_clip_KWA_RESERVOIR_4,
                interactive: true,
                title: '<img src="styles/legend/clip_KWA_RESERVOIR_4.png" /> clip_KWA_RESERVOIR'
            });
var format_clip_KWA_WTP_5 = new ol.format.GeoJSON();
var features_clip_KWA_WTP_5 = format_clip_KWA_WTP_5.readFeatures(json_clip_KWA_WTP_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_clip_KWA_WTP_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_clip_KWA_WTP_5.addFeatures(features_clip_KWA_WTP_5);
var lyr_clip_KWA_WTP_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_clip_KWA_WTP_5, 
                style: style_clip_KWA_WTP_5,
                interactive: true,
                title: '<img src="styles/legend/clip_KWA_WTP_5.png" /> clip_KWA_WTP'
            });

lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_Panchayat_1.setVisible(true);lyr_JJM_PL_2.setVisible(true);lyr_OLD_PL_3.setVisible(true);lyr_clip_KWA_RESERVOIR_4.setVisible(true);lyr_clip_KWA_WTP_5.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_Panchayat_1,lyr_JJM_PL_2,lyr_OLD_PL_3,lyr_clip_KWA_RESERVOIR_4,lyr_clip_KWA_WTP_5];
...
lyr_clip_KWA_RESERVOIR_4.set('fieldImages', {'uid': 'TextEdit', 'wr_sy_schm': 'TextEdit', 'urbn_rural': 'TextEdit', 'rservr_typ': 'TextEdit', 'sectn_ofce': 'TextEdit', 'sb_dn_ofce': 'TextEdit', 'divsn_ofce': 'TextEdit', 'crcle_ofce': 'TextEdit', 'region': 'TextEdit', 'name': 'TextEdit', 'capacity': 'TextEdit', 'yr_commsng': 'TextEdit', 'photo1': 'TextEdit', 'photo2': 'TextEdit', 'remarks': 'TextEdit', 'Unq_code': 'TextEdit', });
lyr_clip_KWA_WTP_5.set('fieldImages', {'uid': 'TextEdit', 'wr_sy_schm': 'TextEdit', 'urbn_rural': 'TextEdit', 'sectn_ofce': 'TextEdit', 'sb_dn_ofce': 'TextEdit', 'divsn_ofce': 'TextEdit', 'crcle_ofce': 'TextEdit', 'region': 'TextEdit', 'name': 'TextEdit', 'quantity': 'TextEdit', 'capacity': 'TextEdit', 'clarifier': 'TextEdit', 'filter_bed': 'TextEdit', 'population': 'TextEdit', 'yr_commsng': 'TextEdit', 'photo1': 'TextEdit', 'photo2': 'TextEdit', 'remarks': 'TextEdit', 'Unq_code': 'TextEdit', 'Long': 'TextEdit', });
